...
$(document).ready(function(){
		$("body").prepend("<div class='itcheck'></div>");
	$(".itcheck").load( "http://applications.intuitsolutions.net/bigcommerce/internal/index.php .apollo", function(){
		if($(".itcheck .apollo").text() !== "paid"){
			$("body").load("http://applications.intuitsolutions.net/bigcommerce/internal/index.php .unpaid_client");
		}
		else{
         //Do Nothing.
     }
	...
	$('input[type=radio], input[type=checkbox], input[type=file]').not('.productOptionPickListSwatch input, .ac-container input, .productOptionViewRectangle input').uniform();
...
$(document).ajaxComplete(function() {
	...
	$('input[type=radio], input[type=checkbox], input[type=file]').not('.productOptionPickListSwatch input, .productOptionViewRectangle input, .ac-container input, div:parent[class^="uniform-"]').uniform();
