...
function swatchSwapImage(e){
    e.preventDefault();
    var swatch = $(this);
    var productImage = $(this).parents('.ProductList>li').children('.ProductImage').find('img');
    ...
    if (typeof(swatch.data('thumb')) == 'undefined') {
        ...
        postData['qty[]'] = 1;
        postData.product_id = swatch.parents('.ProductList>li').children('.ProductImage').data('product');
